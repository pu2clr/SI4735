...
#define ESP32_RESET_PIN 16  // GPIO16

#define ESP32_IO_SDA 21   // GPIO21  -- See LilyGO T-embed setup
#define ESP32_IO_SCL 22   // GPIO22  
...
void setup() {
  ...
  Wire.begin(ESP32_IO_SDA , ESP32_IO_SCL); 
  ...
  radio.getDeviceI2CAddress(ESP32_RESET_PIN); // Looks for the I2C bus address and set it.  Returns 0 if error
  radio.setup(ESP32_RESET_PIN, MW_BAND_TYPE); //
