...
Band band[] = {
  {   "FM", FM_BAND_TYPE,  FM,  6400, 10800,  9890,10}, //  FM          0
  {   "LW", LW_BAND_TYPE,  AM,   153,   279,   198, 1}, //  LW          1
  {   "MW", MW_BAND_TYPE,  AM,   520,  1710,  1000,10}, //  MW          2
  {  "NDB", LW_BAND_TYPE,  AM,   200,   500,   284, 1}, //  LW          3
  { "630M", SW_BAND_TYPE, LSB,   472,   479,   475, 1}, // Ham  630M    4
  { "160M", SW_BAND_TYPE, LSB,  1800,  1910,  1899, 1}, // Ham  160M    5
  {  "90M", SW_BAND_TYPE,  AM,  3200,  3400,  3300, 5}, //       90M    6
  {  "75M", SW_BAND_TYPE,  AM,  3900,  4000,  3950, 5}, //       75M    7
  {  "80M", SW_BAND_TYPE, LSB,  3500,  3800,  3720, 1}, // Ham   80M    8
  {  "60M", SW_BAND_TYPE,  AM,  4750,  5060,  5000, 5}, //       60M    9
  {  "60M", SW_BAND_TYPE, USB,  5330,  5410,  5375, 1}, // Ham   60M   10
  {  "49M", SW_BAND_TYPE,  AM,  5900,  6200,  6000, 5}, //       49M   11
  {  "40M", SW_BAND_TYPE, LSB,  6900,  7200,  7132, 1}, // Ham   40M   12
...
//=======================================================================================
  ...
  tft.setCursor(7, 75);
  tft.println(" SOFT PU2CLR-PE0MGB");
  tft.setCursor(7, 125);
  tft.println(" HARD BY THIAGO");
  tft.setCursor(7, 200);
  tft.setFreeFont(NULL);
  delay(1000);
