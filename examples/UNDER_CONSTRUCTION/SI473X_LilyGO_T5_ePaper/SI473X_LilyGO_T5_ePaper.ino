...
// ESP32 Pins used by the LilyGO T5 ePaper V213.
...
// Enconder PINs
#define ENCODER_PIN_A 25 // GPIO13
#define ENCODER_PIN_B 26 // GPIO14
...
void showSplash();
void inline turnDeviceOn()
{
  pinMode(EPD_POWER_ENABLE, OUTPUT);
  digitalWrite(EPD_POWER_ENABLE, HIGH);
}

void inline turnDeviceOff()
{
...
void setup(void)
{
  ...
  if (digitalRead(ENCODER_PUSH_BUTTON) == LOW)
  {
    ...
    EEPROM.commit();
    print(0, 30, &FreeMonoBold12pt7b, "RESETED");
    delay(4000);
...
{
  display.fillRect(10, 120, 220, 40, GxEPD_WHITE);
  print(80, 130, &FreeMonoBold9pt7b, msg);
}
...
void showSplash(void)
{
  ...
  print(0, 20, &FreeMonoBold9pt7b, "PU2CLR SI4735");
  display.setCursor(0, 50);
  print(0, 50, &FreeMonoBold9pt7b, "Arduino Library");
  display.update();
  delay(4000);
}
...
void showRSSI()
{
  ...
  display.fillRect(0, 25, 128, 10, GxEPD_BLACK);
  display.setTextSize(1);
...
{
  display.fillRect(40, 0, 50, 8, GxEPD_BLACK);
