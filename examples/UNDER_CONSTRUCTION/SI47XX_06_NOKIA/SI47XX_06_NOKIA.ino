...
// NOKIA 5110 pins
#define NOKIA_SCK 13  // SCK is LCD serial clock (SCLK)
#define NOKIA_DIN 11  // MOSI is LCD DIN 
#define NOKIA_DC   5  // LCD Data/Command select (D/C) (DC)
#define NOKIA_CE   4  // LCD chip select (CE or CS)
#define NOKIA_RST  6  // LCD reset (RST)


// Buttons controllers (Some Analog pins are used as digital pin)
#define MODE_SWITCH 14      // A0 - Switch MODE (Am/LSB/USB)
#define BANDWIDTH_BUTTON 15 // A1 - Used to select the banddwith. Values: 1.2, 2.2, 3.0, 4.0, 0.5, 1.0 KHz
#define VOL_UP 16           // A2 - Volume Up
#define VOL_DOWN 17         // A3 - Volume Down
#define BAND_BUTTON_UP 20   // A6 - Next band
#define BAND_BUTTON_DOWN 21 // A7 - Previous band
#define AGC_SWITCH 8        // D8 - Switch AGC ON/OF
#define STEP_SWITCH 9       // D9 Used to select the increment or decrement frequency step (1, 5 or 10 KHz)
#define BFO_SWITCH 10       // Used to select the enconder control (BFO or VFO)
