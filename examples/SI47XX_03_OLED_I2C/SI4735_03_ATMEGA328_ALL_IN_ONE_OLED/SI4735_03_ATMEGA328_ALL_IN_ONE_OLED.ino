...
#define AGC_SWITCH 10       // Switch AGC ON/OF
#define STEP_SWITCH 11     // Used to select the increment or decrement frequency step (1, 5 or 10 KHz)
...
Band band[] = {
  ...
  {SW_BAND_TYPE, 1800, 30000, 7205, 5},  
  {SW_BAND_TYPE, 1800, 30000, 11940, 5}
}; // 10 meters
...
void resetBuffer() {
  oldFreq[0] = oldMode[0] =  oldUnit[0] = oldStep[0] = oldBandwitdt[0] = oldExtraSignalInfo[0] = oldRssi[0] = oldSnr[0] = oldBfo[0] = oldStepBfo[0] = oldVolume[0] = '\0'; 
}
