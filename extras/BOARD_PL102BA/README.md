...
The video below shows the __"PL102BA-S V:2.1 10628"__ device working with the sketch [SI47XX_02_RDS_TFT_TOUCH_SHIELD](https://github.com/pu2clr/SI4735/tree/master/examples/SI47XX_10_RDS/SI47XX_02_RDS_TFT_TOUCH_SHIELD). That sketch was built to work on SI4735-D60 and SI4735-A10. So, the SSB function will not work. To add the encoder and push buttons, follow the schamatic below.
