...
// PATCH INIT CONTENT - Copy and paste the SSB patch for whole SSBRX initialization string
const static PROGMEM byte ssb_patch_content_initialization[] =
...
const static PROGMEM byte ssb_patch_content_full[] = {
